...
class BoardsModel extends BoardsModelGen {
  BoardsModel({String? id, int? taskCount, String? boardName, String? description, String? createdAt, String? updatedAt})
    : super(id, taskCount, boardName, description, createdAt, updatedAt);
